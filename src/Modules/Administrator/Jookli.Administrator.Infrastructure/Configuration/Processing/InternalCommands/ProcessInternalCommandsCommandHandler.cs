...
namespace Jookli.Administrator.Infrastructure.Configuration.Processing.InternalCommands
{
    internal class ProcessInternalCommandsCommandHandler : ICommandHandler<ProcessInternalCommandsCommand>
    {
        ...
        public async Task<Unit> Handle(ProcessInternalCommandsCommand request, CancellationToken cancellationToken)
        {
            ...
            string sql = "SELECT " +
                               ...
                               "FROM dbo.Games_InternalCommands AS Command " +
            ...
            foreach(var internalCommand in internalCommandsList)
            {
                ...
                if(result.Outcome == OutcomeType.Failure)
                {
                    await connection.ExecuteScalarAsync(
                        "UPDATE dbo.Games_InternalCommands " +
